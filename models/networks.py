...
from .stylegan_networks import StyleGAN2Discriminator, StyleGAN2Generator, StyleGAN2EnCoGenerator
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    elif netG == 'stylegan2enco':
        net = StyleGAN2EnCoGenerator(input_nc, output_nc, ngf, use_dropout=use_dropout, opt=opt)
...
def define_F(input_nc, netF, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, no_antialias=False,
    ...
    elif netF == 'mlp_sample_with_DAG':
        net = PatchSampleWithDAGF(use_mlp=True, init_type=init_type, init_gain=init_gain, gpu_ids=gpu_ids,
...
class PatchSampleWithDAGF(nn.Module):
    ...
    def forward(self, feats, num_patches=64, patch_ids=None, cams=None, prj=False):
        ...
        for feat_id, feat in enumerate(feats):
            B, H, W = feat.shape[0], feat.shape[2], feat.shape[3]
            feat_reshape = feat.permute(0, 2, 3, 1).flatten(1, 2)  # B, L, D
